...
Tip.create(description:"Eat Breakfast",user_id:1,date:"2020/01/04")
Tip.create(description:"Stretch before exercising",user_id:1,date:"2020/01/04")
Tip.create(description:"Drink more water",user_id:1,date:"2020/01/04")
Tip.create(description:"Sleep Early",user_id:1,date:"2020/01/04")
Tip.create(description:"Make this a habit",user_id:1,date:"2020/01/04")